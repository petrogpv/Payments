...
import ua.gordeichuk.payments.controller.util.Parser;
...
public class Validator {
    ...
    public static Date validateAndParseDate(String dateString, String locale)
    ...
    public static void validateDates(Date dateFrom, Date dateTo) throws ServiceException {
    ...
    private static Long parseMoneyValue (String value){
        String resultValue;
    ...
    public static void validatePasswordsOnSignUp(String password, String passwordConfirm)
            throws ServiceException {
    ...
    public static void validateCardsNotEquals(Long cardIdFrom, Long cardIdTo)
            throws ServiceException {
    ...
    public static void validateSortType(String sortType) throws ServiceException {
