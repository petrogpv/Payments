...
public class JdbcAccountDao extends JdbcEntityDao<Account> implements AccountDao {
    ...
    protected static Account extractAccountFromResultSet(ResultSet resultSet) throws SQLException {
    ...
    @Override
    protected void setEntityToPreparedStatement(Account account, PreparedStatement statement) throws SQLException {
