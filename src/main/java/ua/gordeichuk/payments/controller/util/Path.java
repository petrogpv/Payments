...
public class Path {
    ...
    public static final String MANAGE = "/admin/manage";
    public static final String MANAGE_ACTION = "/admin/manage/action";
    public static final String ADD_USER = "/admin/add_user";
