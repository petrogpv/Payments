...
public final class Page {
    ...
    public static final String MANAGE_CARDS = "/WEB-INF/pages/manage_cards.jsp";
    public static final String MANAGE_USERS = "/WEB-INF/pages/manage_users.jsp";
    public static final String HISTORY = "/WEB-INF/pages/history.jsp";
    public static final String SEARCH = "/WEB-INF/pages/search_unlock.jsp";
    ...
    public static final String ADD_USER = "/WEB-INF/pages/add_user.jsp";
}
